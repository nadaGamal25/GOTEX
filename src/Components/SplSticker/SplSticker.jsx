          ...
          <tr>
            <td colSpan="4" style={{ border: '1px solid black' }}>
              <p style={{ margin: '5px 0 0 10px' }}>
                {item.sender.name}<br />
                {item.sender.AddressLine1},
              </p>
              <hr style={{ margin: '2px 10px' }} />
              <p style={{ margin: '0 0 5px 10px' }}>{item.sender.city} ,{item.sender.mobile}</p>
            </td>
          </tr>
          <tr>
            <td colSpan="4" style={{ border: '1px solid black' }}>
              <table width="100%" border="0" cellPadding="0" cellSpacing="0" style={{ borderCollapse: 'collapse' }}>
                ...
                <tr>
                  <td colSpan="2"><p style={{ marginLeft: '10px' }}>{item.reciver.city} , {item.reciver.AddressLine1}</p></td>
                </tr>
                {/* <tr>
