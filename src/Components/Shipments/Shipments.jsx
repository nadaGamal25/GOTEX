...
export default function Shipments(userData) {
  ...
  async function getJtUserOrders() {
    try {
      const response = await axios.get('https://dashboard.go-tex.net/test/jt/get-all-orders',
      {
        headers: {
  ...
  async function getImileUserOrders() {
    try {
      const response = await axios.get('https://dashboard.go-tex.net/test/imile/get-all-orders',
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('userToken')}`,
        },
  ...
  async function getSplUserOrders() {
    try {
      const response = await axios.get('https://dashboard.go-tex.net/test/spl/get-all-orders',
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('userToken')}`,
        },
  ...
  async function getGotexUserOrders() {
    try {
      const response = await axios.get('https://dashboard.go-tex.net/test/anwan/get-all-orders',
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('userToken')}`,
        },
      ...
      async function getGltUserOrders() {
        try {
          const response = await axios.get('https://dashboard.go-tex.net/test/glt/get-all-orders',
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem('userToken')}`,
            },
      ...
      async function getSmsaUserOrders() {
        try {
          const response = await axios.get('https://dashboard.go-tex.net/test/smsa/get-all-orders',
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem('userToken')}`,
            },
      ...
      async function getAramexUserOrders() {
        try {
          const response = await axios.get('https://dashboard.go-tex.net/test/aramex/get-all-orders',
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem('userToken')}`,
            },
  ...
  //         const newTab = window.open();
  //         newTab.location.href = `https://dashboard.go-tex.net/test${stickerUrl}`;
  //       });
  //     } else {
  ...
  // }
   ...
   async function getUserOrders() {
        ...
        try {
          const response = await axios.get('https://dashboard.go-tex.net/test/saee/get-all-orders',
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem('userToken')}`,
            },
...
{/* <div className="search-box p-4 mt-2 row g-1">
    ...
    <tr>
      ...
      // async function getOrderSticker(orderId) {
      //   try {
      //     const response = await axios.get(`https://dashboard.go-tex.net/test/saee/print-sticker/${orderId}`, {
      //       headers: {
      //         Authorization: `Bearer ${localStorage.getItem('userToken')}`,
      //       },
      //     });
...
{/* <div className="clients-table p-4 my-4">
    ...
    //  </div>
      ...
      //   try {
      //     const response = await axios.get(
      //       `https://dashboard.go-tex.net/test/glt/print-sticker/${orderId}`,
      //       {
      //         headers: {
      //           Authorization: `Bearer ${localStorage.getItem('userToken')}`,
      //         },
